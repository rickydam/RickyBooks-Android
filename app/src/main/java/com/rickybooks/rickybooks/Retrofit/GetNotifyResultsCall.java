...
public class GetNotifyResultsCall {
    private MainActivity activity;
    private List<Textbook> notifyResults;
    private boolean isSuccessful;

    public GetNotifyResultsCall(MainActivity activity) {
    ...
    public void req() {
        ...
        try {
            ...
            Call<JsonArray> call = textbookService.getNotifyResults(tokenString, userId);
