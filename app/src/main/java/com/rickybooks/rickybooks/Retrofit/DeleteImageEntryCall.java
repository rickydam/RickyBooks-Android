...
public class DeleteImageEntryCall {
    private MainActivity activity;
    private boolean isSuccessful;

    public DeleteImageEntryCall(MainActivity activity) {
    ...
    public void req(String textbookId) {
        ...
        try {
            ...
            Call<Void> call = textbookService.deleteImageEntry(tokenString, textbookId);
