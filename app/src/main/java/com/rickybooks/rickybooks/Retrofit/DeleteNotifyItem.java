...
public class DeleteNotifyItem {
    private MainActivity activity;
    private boolean isSuccessful;

    public DeleteNotifyItem(MainActivity activity) {
    ...
    public void req(String notifyItemId) {
        ...
        try {
            ...
            Call<Void> call = textbookService.deleteNotifyItem(tokenString, notifyItemId);
